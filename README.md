...
Source Audio C4 Synth pedal is an awesome guitar/bass effect but lacks preset browse and selection functionalities
...
The basic Python code included in this repository demonstrates the possibility to use HID interrupt enpoints to display and change presets. It uses Python HID libraries. IT is mainly aimed at testing communication protocol.
